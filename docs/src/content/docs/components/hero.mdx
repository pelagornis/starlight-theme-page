...
The Hero component displays a prominent hero section at the top of your documentation site with customizable title, tagline, and action buttons.
...
1. **Keep taglines concise**: Aim for one to two sentences
