...
<Tabs syncKey="animations">

<TabItem label="Pulse 애니메이션">
...
<Tabs syncKey="header-customization">

<TabItem label="Astro 컴포넌트">
...
<Tabs syncKey="performance">

<TabItem label="GPU 가속">
