...
H1부터 H4까지 모든 제목 스타일을 확인할 수 있습니다.

### 🔗 링크와 버튼

호버 시 그라데이션 언더라인이 나타나는 링크들

### 💻 코드 블록

구문 강조와 복사 기능이 있는 코드 블록
...
<Tabs
  tabs={[
    { id: "unordered", label: "순서 없는 리스트" },
    { id: "ordered", label: "순서 있는 리스트" },
  ]}
  defaultTab="unordered"
>
  <div>
    - 첫 번째 항목
    - 두 번째 항목
    ...
    <figure class="frame is-terminal not-content">
      ...
      <pre data-language="bash">
        <code>
          <div class="ec-line">
            <div class="code">
              <span style="--0:#82AAFF;--1:#3B61B0">npm</span>
              <span style="--0:#D6DEEB;--1:#403F53"> </span>
              <span style="--0:#ECC48D;--1:#3B61B0">install</span>
              <span style="--0:#D6DEEB;--1:#403F53"> </span>
              <span style="--0:#ECC48D;--1:#3B61B0">@pelagornis/page</span>
            </div>
          </div>
        </code>
      </pre>
      <div class="copy">
        <button
          ...
          data-copied="Copied!"
          data-code="npm install @pelagornis/page"
        >
          <div></div>
        </button>
      </div>
...
1. **테마 설치**: `npm install @pelagornis/page`

2. **Astro 설정**: `astro.config.js`에 플러그인 추가

3. **스타일 적용**: `customCss: ["@pelagornis/page/styles"]`
